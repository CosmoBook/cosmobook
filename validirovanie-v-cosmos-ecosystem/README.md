...
<figure><img src="../.gitbook/assets/twi.png" alt=""><figcaption></figcaption></figure>
...
$$
прибыль = APR*(self bond + (делегация-self bond)*комиссия валидатора)
$$

**self bond** - собственная делегация (те токены, которые валидатор грузит сам в себя).

Чтобы понять кухню лучше, сходите в [гитхаб](https://github.com/bro-n-bro/prometheus\_exporter/blob/main/docs/APR%20calcucation.md) к Bro\_n\_Bro, они досконально разобрали эту тему.

```
Исходные данные:
Делегация 5285 SCRT;
Комиссия валидатора 5 %;
АПР 24,43% (https://www.mintscan.io/secret);
Собственная делегация (self-bonded) 20 SCRT.
```
...
[Сергей freak12techno](https://t.me/freak12techno) ([🐹 Quokka Stake](https://www.cosmobook.io/cosmobook/v/russian/validirovanie-v-cosmos-ecosystem/russkogovoryashie-validatory/quokka-stake))

[Антон Павлуцкий](https://t.me/pavlutsky) (CEO [Citadel.one](https://www.cosmobook.io/cosmobook/v/russian/validirovanie-v-cosmos-ecosystem/russkogovoryashie-validatory/citadel.one))

[Валера Микитенко](https://t.me/mykytenkovalera) (канал [https://t.me/Yung\_HoDler](https://t.me/Yung\_HoDler))

[Ushakov](https://t.me/MasterDanila) (валидатор [ushakov](https://www.cosmobook.io/cosmobook/v/russian/validirovanie-v-cosmos-ecosystem/russkogovoryashie-validatory/ushakov))
