...
Михаил (М) хочет атаковать сеть. Для этого он исключает блоки Василия (В) и Анфисы (А). Исключённые блоки изображены в скобках, вверху форк жулика, который идёт параллельно основной последовательности блоков (внизу).![](<../.gitbook/assets/image (17).png>)
