...
Число нод-валидаторов в Secret Network по умолчанию составляет восемьдесят, при этом есть возможность присоединения большего числа нод к сети после согласования изменений в параметрах протокола. Валидаторы получают вознаграждение в виде транзакционных комиссий и наград за подпись блока.
